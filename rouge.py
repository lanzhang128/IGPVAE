# Copy from https://github.com/google/seq2seq/blob/master/seq2seq/metrics/rouge.py.
...
def rouge(hypotheses, references):
  ...
  references. We make our own modification here."""
  ...
  # Calculate ROUGE-4 F1, precision, recall scores
  rouge_4 = [
      rouge_n([hyp], [ref], 4) for hyp, ref in zip(hypotheses, references)
  ]
  ...
  return {
      ...
      "rouge_4/f_score": rouge_4_f,
      "rouge_4/r_score": rouge_4_r,
      "rouge_4/p_score": rouge_4_p,
  }